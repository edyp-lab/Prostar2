...
#' 
mod_convert_ms_file_server <- function(id, pipeline.def){
  ...
  moduleServer(id, function(input, output, session){
    ...
    rv.convert$pipeline <- mod_choose_pipeline_server('choose_pipeline_ui', pipeline.def=reactive({pipeline.def()}), dataType = input$typeOfData)
