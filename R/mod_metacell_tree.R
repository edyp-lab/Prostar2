        ...
        tags$ul(
          tags$li(
            checkboxInput(
              ns("quantified_cb"),
              tags$span(
                style = Get_bg_color("quantified_cb"),
            ...
            tags$ul(
              tags$li(
                checkboxInput(
                  ns("quantbydirectid_cb"),
                  tags$span(
                    style = Get_bg_color("quantbydirectid_cb"),
              ...
              tags$li(
                checkboxInput(
                  ns("quantbyrecovery_cb"),
                  tags$span(
                    style = Get_bg_color("quantbyrecovery_cb"),
            ...
            tags$ul(
              tags$li(
                checkboxInput(
                  ns("missingpov_cb"),
                  tags$span(
                    style = Get_bg_color("missingpov_cb"),
              ...
              tags$li(
                checkboxInput(
                  ns("missingmec_cb"),
                  tags$span(
                    style = Get_bg_color("missingmec_cb"),
            ...
            tags$ul(
              tags$li(
                checkboxInput(
                  ns("imputedpov_cb"),
                  tags$span(
                    style = Get_bg_color("imputedpov_cb"),
              ...
              tags$li(
                checkboxInput(
                  ns("imputedmec_cb"),
                  tags$span(
                    style = Get_bg_color("imputedmec_cb"),
          ...
          tags$li(
            checkboxInput(
              ns("combinedtags_cb"),
              tags$span(
                style = Get_bg_color("combinedtags_cb"),
