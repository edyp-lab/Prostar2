...
mod_legend_colored_exprs_ui <- function(id){
  ns <- NS(id)
  tagList(
...
mod_legend_colored_exprs_server <- function(input, output, session){
  ns <- session$ns
  
}
    
## To be copied in the UI
# mod_legend_colored_exprs_ui("legend_colored_exprs_ui_1")
    
## To be copied in the server
# callModule(mod_legend_colored_exprs_server, "legend_colored_exprs_ui_1")
