...
This vignette aims to describe the core code of Prostar and is addressed to developers.
...
* **Data manager**:
  ...
  * Convert: through several steps, converts Excel or CSV files containing quantitative data to an object of class Features,
