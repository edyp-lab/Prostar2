...
#' 
#' In this example, `PipelinePeptide_HypothesisTest_ulength(rv$dataIn)` and `PipelinePeptide_HypothesisTest_server()` define
...
#' shiny::runApp(workflowApp("PipelinePeptide_HypothesisTest", path, dataIn = Exp1_R25_prot))
#' }
#' 
#' @rdname PipelinePeptide
#' @export
#' 
PipelinePeptide_HypothesisTest_conf <- function(){
  MagellanNTK::Config(
    fullname = 'PipelinePeptide_HypothesisTest',
    mode = 'process',
...
#' @export
#'
PipelinePeptide_HypothesisTest_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' 
PipelinePeptide_HypothesisTest_server <- function(id,
