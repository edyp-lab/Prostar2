...
#' 
#' In this example, `PipelinePeptide_DA_UI()` and `PipelinePeptide_DA_server()` define
...
#' @export
#' 
PipelinePeptide_DA_conf <- function(){
  MagellanNTK::Config(
    fullname = 'PipelinePeptide_DA',
    mode = 'process',
...
#' @export
#'
PipelinePeptide_DA_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' 
PipelinePeptide_DA_server <- function(id,
