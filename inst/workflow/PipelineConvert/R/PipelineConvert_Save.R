...
#' @export
#' @rdname PipelineConvert_Save
PipelineConvert_Save_conf <- function(){
  MagellanNTK::Config(
    fullname = 'PipelineConvert_Save',
    mode = 'process'
  )
}
...
#' @export
#' @rdname PipelineConvert_Save
PipelineConvert_Save_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' @rdname PipelineConvert_Save
PipelineConvert_Save_server <- function(id,
